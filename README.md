...
**CupNote v1.5.0**는 스페셜티 커피 애호가들을 위한 iOS TestFlight 출시 준비된 커피 기록 & 커뮤니티 플랫폼입니다.

전문가의 복잡한 용어에 부담을 느끼지 않고, 자신만의 언어로 커피를 기록하고 다른 사람들과 경험을 나눌 수 있습니다.

### 🌐 라이브 서비스
- **프로덕션 URL**: https://mycupnote.com
- **상태**: ✅ v1.5.0 TestFlight 배포 준비 완료 (2025-08-07)
- **기능**: 완전한 PWA, 하이브리드 디자인, 커뮤니티 매치 점수, 성취 시스템, 실시간 DB 연동
- **최신 업데이트**: 첫 기록자 100% 매치 점수, 기록 저장 시스템 완전 수정, 더미 데이터 제거

### 📱 TestFlight Beta (v1.5.0)
- **상태**: 🚀 배포 준비 완료 (2025-08-07)
- **iOS 버전**: iPhone 전용, Marketing Version 1.5.0 (Build 5)
- **핵심 수정**: 첫 기록자 매치 점수 40% → 100%, 기록 저장 오류 완전 해결
- **배포 가이드**: [TestFlight Deployment Guide](TESTFLIGHT_DEPLOYMENT_GUIDE.md)
