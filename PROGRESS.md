...
- [ ] **4-Mode 시스템 설계**: Quick, Cafe, HomeCafe, Pro 모드로 확장
- [ ] **Token System 구현**: 모드 이름 및 UI 라벨 중앙집중화 관리
- [ ] **Mode Selection 업데이트**: 4개 모드 선택 UI 개선
- [ ] **Quick Mode**: 현재 4단계 구조를 빠른 기록 모드로 전환
