  ...
  createRealisticValidationPlan(): ValidationPlan {
    return {
      ...
      problem_validation: {
        ...
        red_flags: ['문제라고 생각하지 않음', '해결하고 싶어하지 않음', '현재 방법으로 만족'],
      },
  ...
  createRealisticResearch(): ResearchPlan {
    return {
      ...
      qualitative_research: {
        ...
        avoid: ['우리 솔루션에 대한 직접적 질문', '가정적 상황 질문', '유도 질문'],
      },
  ...
  analyzeMarketTiming(): TimingAnalysis {
    return {
      ...
      too_early: {
        ...
        strategies: ['시장 교육에 집중', '얼리어답터 타겟팅', '미래 준비하며 기다리기'],
      },
      ...
      too_late: {
        ...
        strategies: ['틈새 시장 공략', '기존 플레이어 대상 B2B', '새로운 접근 방식으로 차별화'],
      },
    }
  }
