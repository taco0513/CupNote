  ...
  <div class="coffee-info-view">
    ...
    <main class="coffee-form">
      ...
      <div class="form-group">
        ...
        <input id="price" v-model="coffeeInfo.price" type="number" placeholder="예: 8500" />
      </div>
    </main>

    <!-- 네비게이션 버튼 -->
    <footer class="navigation">
      <button @click="goBack" class="btn-secondary">← 이전</button>
      <button @click="saveCoffeeInfo" class="btn-primary">다음 →</button>
    </footer>
  </div>
</template>
```
