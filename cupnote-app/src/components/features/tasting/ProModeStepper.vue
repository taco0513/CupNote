        ...
        <div :key="currentStep.id" class="step-panel">
          ...
          <div v-if="currentStep.timer" class="step-timer">
            ...
            <div class="timer-controls">
              <button class="timer-btn" @click="startTimer" :disabled="timerRunning">시작</button>
              <button class="timer-btn" @click="pauseTimer" :disabled="!timerRunning">
                일시정지
              </button>
              <button class="timer-btn" @click="resetTimer">리셋</button>
            </div>
          </div>
          ...
          <div v-if="currentStep.tips" class="step-tips">
            ...
            <div v-for="(tip, idx) in currentStep.tips" :key="idx" class="tip-item">
...
const steps = [
  ...
  },
  {
    ...
    instructions: ['각 항목을 6-10점 스케일로 평가', '결점이 있다면 감점', '총점 계산 및 기록'],
  },
]
