...
const ModeCard = ({ 
  ...
  <Link href={`/record?mode=${mode}`}>
    <div className={`
      relative p-6 bg-white rounded-2xl border-2 transition-all duration-300 cursor-pointer group
    ...
    `}>
      ...
      <div className="flex items-center mb-4">
        <div className={`
          ...
          ${mode === 'cafe' ? 'bg-blue-100 text-blue-600' : 
            mode === 'homecafe' ? 'bg-green-100 text-green-600' : 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-coffee-50 to-coffee-100">
      <div className="container mx-auto px-4 py-4 max-w-4xl">
        ...
        {/* 하단 안내 */}
        <div className="mt-16 bg-white rounded-2xl p-8 border border-coffee-200">
