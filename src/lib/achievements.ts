...
export const DEFAULT_ACHIEVEMENTS: Omit<Achievement, 'unlocked' | 'unlockedAt' | 'progress'>[] = [
  ...
  // 전문성 성취 (4개)
  {
    ...
    icon: '🎯',
    category: 'expertise',
    condition: { type: 'match_score', target: 5, field: 'high_scores', value: 90 },
    reward: { points: 100 },
  },
  {
    id: 'flavor-hunter',
  ...
  },
  {
    ...
    icon: '💎',
    category: 'expertise',
    condition: { type: 'match_score', target: 1, field: 'perfect_scores', value: 100 },
    reward: { points: 200 },
  },
  {
    id: 'brewing-expert',
  ...
  },
  {
    ...
    icon: '✈️',
    category: 'exploration',
    condition: { type: 'continents', target: 5, field: 'continents' },
    reward: { points: 300 },
  },
